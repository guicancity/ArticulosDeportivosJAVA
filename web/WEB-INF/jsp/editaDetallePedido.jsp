<%-- 
    Document   : editaDetallePedido
    Created on : 19/09/2020, 03:17:19 PM
    Author     : JEISSON
--%>
...
<html>
    <head>
        ...
        <title> Articulos Deportivos || Actualizar Productos </title>
    </head>
    <body>
        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col text-center"> <h1> Actualizar productos</h1> </div>
                    </div>
                    <form method="POST" > 
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6">
                                <h5>Cantidad</h5>
                                <input type="number" name="cantidad" required="" class="form-control" value="${lsDetallePedido[0].cantidad}" > 
                            </div>
                        </div>
